              ...
              <div className="relative mb-2">
                ...
                >
                  <div className="w-full bg-gray-200 rounded items-center align-middle align-center flex-1">
                    <div
                      className=" bg-indigo-700 py-1 rounded w-full"
                      // style="width: 100%;"
                    ></div>
                  </div>
                </div>
                ...
                <div className="w-10 h-10 mx-auto bg-indigo-700 rounded-full text-lg text-white flex items-center">
                  <span className="text-center text-white w-full">
                    <svg
                      ...
                      width="24"
                    >
                      <path d="M456.13 873.522q-9.434-9.196-9.434-23.75 0-14.555 9.434-23.99l215.718-215.717H191.435q-14.674 0-24.37-9.695-9.695-9.696-9.695-24.37 0-14.674 9.695-24.37 9.696-9.695 24.37-9.695h480.413L456.13 325.978q-9.434-9.195-9.434-24.25 0-15.054 9.434-24.489 9.435-9.196 23.99-9.196 14.554 0 23.989 9.196L779 552.13q5.478 5.479 7.837 11.316 2.359 5.837 2.359 12.554 0 5.957-2.359 12.174T779 599.87L504.109 874.761q-9.435 9.435-23.989 8.815-14.555-.619-23.99-10.054Z" />
                    </svg>
                  </span>
                </div>
              </div>
            ...
            <div className="w-1/3">
              <div className="relative mb-2">
                ...
                >
                  <div className="w-full bg-gray-200 rounded items-center align-middle align-center flex-1">
                    <div
                      className=" bg-indigo-700 py-1 rounded w-1/2"
                      //  style="width: 50%;"
                    ></div>
                  </div>
                </div>
